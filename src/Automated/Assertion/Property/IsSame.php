...
/**
 * class IsSame
 * Invokable class to use with Teknoo\States\Automated\Assertion to check if a propery has the
 ...
 * @author      Richard Déloge <richarddeloge@gmail.com>
 */
class IsSame extends AbstractConstraint implements ConstraintInterface
{
    use ImmutableTrait;
